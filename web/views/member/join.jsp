...
<link rel="stylesheet" href="/KH_JSP_war_exploded/resources/css/header.css" />
<style>
	section {
		width : 700px;
		height: auto;
...
<body>
	...
	<section>
		...
		<form action="/KH_JSP_war_exploded/insert.do" method="post" id="joinForm">
			...
			<table align="center">
				...
				<tr>
					<td>나이 </td>
					<td>
						<input type="number" name="age" min="10" max="100" value="10"
					      style="width:140px;">세
					</td>
					<td></td>
				</tr>
